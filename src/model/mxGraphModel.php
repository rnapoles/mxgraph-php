...
class mxGraphModel extends mxEventSource
{
     ...
     */
    public function restoreClone($clne, $cell, $mapping)
    {
     ...
     */
    public function cellAdded($cell)
    {
     ...
     */
    public function updateEdgeParents($cell, $root = null)
    {
     ...
     */
    public function updateEdgeParent($edge, $root)
    {
     ...
     */
    public function cellRemoved($cell)
    {
        if ($cell != null) {
            $childCount = $this->getChildCount($cell);
     ...
     */
    public function setTerminals($edge, $source, $target)
    {
        $this->beginUpdate();
        try {
     ...
     * source edges.
     */
    public function mergeChildren($from, $to, $cloneAllEdges = true)
    {
        $this->beginUpdate();
        try {
            $mapping = array();
     ...
     */
    public function mergeChildrenImpl($from, $to, $cloneAllEdges, $mapping)
    {
        $this->beginUpdate();
        try {
